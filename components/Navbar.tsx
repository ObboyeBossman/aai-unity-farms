  ...
  return (
    <>
      ...
      {/* ─── Mobile Drawer + Backdrop ───────────────────────────────────────────
          IMPORTANT: These are siblings to <header>, NOT children.
          The glass-panel class applies backdrop-filter which creates a new CSS
          containing block — any `fixed` children would then position relative
          to the header instead of the viewport, breaking the drawer layout.
          Keeping them outside the header avoids that trap entirely.
      ──────────────────────────────────────────────────────────────────────── */}
