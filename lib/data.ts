...
export const products: Product[] = [
  ...
  { id: 'crate-eggs', name: 'Crate of Eggs', category: 'Eggs', price: null, unit: 'crate', image: MEDIA.freshEggs },
  ...
  { id: 'layer-chickens', name: 'Layer Chickens', category: 'Poultry', price: 35, unit: 'bird', image: MEDIA.broilerChicken },
  { id: 'day-old-chicks', name: 'Day-Old Chicks', category: 'Poultry', price: 8, unit: 'chick', image: MEDIA.dayOldChicks },
  { id: 'layer-starter', name: 'Layer Starter Feed', category: 'Feeds', price: 180, unit: '50kg bag', image: MEDIA.poultryFeed },
  { id: 'broiler-starter', name: 'Broiler Starter Feed', category: 'Feeds', price: 195, unit: '50kg bag', image: MEDIA.poultryFeed },
  { id: 'grower-mash', name: 'Grower Mash', category: 'Feeds', price: 170, unit: '50kg bag', image: MEDIA.poultryFeed },
